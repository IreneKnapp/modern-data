   ...
   void *client_state)
{
    ...
    result->function_type_left_get = default_function_type_left_get;
    result->function_type_right_get = default_function_type_right_get;
    ...
    result->apply_left_get = default_apply_left_get;
    result->apply_right_get = default_apply_right_get;
    ...
    result->function_type_left_set = default_function_type_left_set;
    result->function_type_right_set = default_function_type_right_set;
    ...
    result->apply_left_set = default_apply_left_set;
    result->apply_right_set = default_apply_right_set;
