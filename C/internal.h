...
INTERNAL void
    ...
    (modern_library *library,
     ...
     struct modern_hash hash);
INTERNAL void 
    default_maybe_just_content_set
    (modern_library *library,
     void *value,
     void *content_value);
INTERNAL void 
...
INTERNAL void 
    ...
    (modern_library *library,
     ...
     void *successor);
INTERNAL void 
    default_named_value_set
    (modern_library *library,
     void *node,
     void *type,
     void *value);
INTERNAL void 
    default_maybe_type_content_type_set
    (modern_library *library,
     void *value,
     void *content_type);
INTERNAL void 
...
INTERNAL void 
    ...
    (modern_library *library,
     ...
     void *field_type);
INTERNAL void 
    default_sigma_type_successor_set
    (modern_library *library,
     void *value,
     void *successor);
INTERNAL void 
    default_named_type_name_set
    (modern_library *library,
     void *value,
     struct modern_hash name);
INTERNAL void 
    default_named_type_content_type_set
    (modern_library *library,
     void *value,
     void *content_type);
INTERNAL void 
    default_universe_type_level_set
    (modern_library *library,
     void *value,
     uint64_t level);
INTERNAL void 
    default_lambda_content_set
    (modern_library *library,
     void *value,
     void *content);
INTERNAL void 
...
INTERNAL void 
    ...
    (modern_library *library,
     ...
     uint64_t index);
INTERNAL void 
    default_type_family_item_remove
    (modern_library *library,
     void *value,
     uint64_t index);
INTERNAL void 
    default_let_item_add
    (modern_library *library,
     void *value,
     void *item,
     uint64_t index);
INTERNAL void 
    default_let_item_remove
    (modern_library *library,
     void *value,
     uint64_t index);
INTERNAL void 
    default_let_content_set
    (modern_library *library,
     void *value,
     void *content);
INTERNAL void 
    default_backreference_index_set
    (modern_library *library,
     void *value,
     uint64_t index);
INTERNAL void 
    default_builtin_identifier_set
    (modern_library *library,
     void *value,
     uint16_t identifier);
